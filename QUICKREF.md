...
- Set schedule: Daily, Weekly, Custom
- Track progress
- Get reminders
...
- Title: "Write a poem"
- Content: "Write a poem about..."
- Category: Creative, Technical, etc.
- **Most used prompts appear first!**

### 🛍️ Marketplace
**Buy/Sell prompts**
- List your best prompts for sale
- Browse what others are selling
- Set custom prices
- Add descriptions
...
| Activity | XP Awarded |
|----------|-----------|
| Complete quiz | Score × 10 |
| Complete daily challenge | 50 |
| Daily challenge streak | 25 bonus |
| Upload & analyze image | 10 |
| Share chat publicly | 25 |
| Create public prompt | 20 |
| Sell prompt in marketplace | 50 |
...
- Anyone with email/password

**What gets saved?**
- Your chats & messages
- Study materials (notes, quizzes, flashcards)
- Code snippets
- Community posts
- Your XP, level, badges, streak
...
**Hidden Features:**
- Leaderboard resets never (cumulative XP)
- Badges stack (earn multiple)
- Daily challenges refresh at midnight UTC
- Streaks break if you skip a day
...
- View logs: tail logs/ren_core.log

**Questions?**
- Read: FEATURES.md (complete docs)
- Read: SETUP.md (setup guide)
- Check: api.js (code examples)
