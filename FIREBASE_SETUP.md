...
- Sign in with Google
- Send a message
- Check [Firebase Console](https://console.firebase.google.com/) → Firestore → Collections → `sessions` → should see your chat there! 🎉

## Security Checklist
- ✅ Firestore rules deployed (only owners see their chats)
- ✅ Service account JSON is in `.gitignore` (never commit it!)
- ✅ ID tokens verified on backend before saving
- ✅ API keys not hardcoded in client
...
**Questions?** I can help with any step! 🚀
